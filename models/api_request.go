...
func (c *Client) ApiRequest(ctx echo.Context, pathName string, method string, body interface{}, strct interface{}) (*http.Response, error) {
	...
	case "application/x-www-form-urlencoded":
		return c.requestUrlEncode(method, jsonData, mapData, body, &strct)
...
func (c *Client) requestUrlEncode(method string, jsonData []byte, mapData map[string]interface{}, body interface{}, strct interface{}) (*http.Response, error) {
	data := url.Values{}
