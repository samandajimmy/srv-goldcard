...
ALTER TABLE applications rename column failed_date to rejected_date;
ALTER TABLE applications add status application_status_enum NOT NULL DEFAULT 'card_suspended';
